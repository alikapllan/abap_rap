CLASS zcl_ahk_demo_rap_fill_team DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    " https://software-heroes.com/blog/btp-custom-data-browser
    " https://software-heroes.com/blog/abap-rap-tree-view
ENDCLASS.


CLASS zcl_ahk_demo_rap_fill_team IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA team_members TYPE STANDARD TABLE OF zahk_dmo_team WITH EMPTY KEY.
    ...
    DELETE FROM zahk_dmo_team.
    INSERT zahk_dmo_team FROM TABLE @team_members.
    COMMIT WORK.
  ENDMETHOD.
ENDCLASS.
