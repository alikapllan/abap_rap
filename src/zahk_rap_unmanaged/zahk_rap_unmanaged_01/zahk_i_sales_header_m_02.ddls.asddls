...
define root view entity ZAHK_I_SALES_HEADER_M_02
  as select from ZAHK_I_SALES_HEADER_02 // select from other CDS
    composition [0..*] of ZAHK_I_SALES_ITEM_M_02 as _SItem_M_02
{
  key sales_doc_num,
      date_created,
      person_created,
